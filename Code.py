...
# set the title 
root.title("Color Game For Windows 3.0!")
my_menu= Menu(root)
...
root.resizable(0,0)
style = Style()
Help = tkinter.Label(root, text = "Color Game For Windows 3.0!", font = ('Ubuntu', 24,"bold","underline")) 
...
Tbutton = tkinter.Button(root,text = "Restart The Game",font=("ubuntu",22),bg="pink",activebackground='#23d18b', command = restart)
Tbutton.pack(side=tk.LEFT)
Tbutton.place(relx=0.5, rely=0.9, anchor=CENTER)
qbutton = tkinter.Button(root,text = "How to play?",font=("ubuntu",22),bg="pink",activebackground='#23d18b', command = howtoplay)
